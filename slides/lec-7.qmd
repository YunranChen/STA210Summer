...
::: appex
📋 [github.com/STA210-Summer22/ae-3-duke-forest](https://github.com/STA210-Summer22?q=ae-3&type=all&language=&sort=)
:::
...
-   inference: linearity + independence + constant variance
    -   simulation-based:
    -   mathematical: normality
