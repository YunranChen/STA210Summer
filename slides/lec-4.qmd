...
-   `set_engine`: what alternatives? can use [`show_engines("linear_reg")`](https://parsnip.tidymodels.org/reference/show_engines.html)
-   In R code chunk, can set `#| message: false` and `#| warning: false` 
-   Two teams, check [github](https://github.com/orgs/sta210-s22/teams)! 
...
::: appex
📋 [github.com/STA210-Summer22/ae-2-dcbikeshare](https://github.com/STA210-Summer22?q=ae-2&type=all&sort=)
