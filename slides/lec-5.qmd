...
## Tips for collaboration on Github
...
![](images/lec-5/merge.png){fig-alt="Illustration on Github merge issues" fig-align="center" width="250"}

## Merge Issue on Github

![](images/lec-5/merge-conflict.jpeg){fig-alt="Github merge issues" fig-align="center" width="250"}
## Merge Issue on Github
...
-   Evaluating models' performance for fitting
    -   R-squared, RMSE
...
-   Evaluating predictive performance: Split the data into testing and training sets, build models using only the **training set**, and evaluate their performance on the **testing set**, and repeat to see how your model holds up to "new" data
...
-   **Slope:** For each additional square foot, the model predicts (we expect) the sale price of Duke Forest houses to be higher, on average, by `r dollar(slope)`.
