...
::: callout-important
I will lead you through the Getting Started section.
:::
...
usethis::use_git_config(
  user.name = "YunranChen", 
  user.email = "yunran.chen@duke.edu"
  )
```
...
-   Go to the course organization at [github.com/STA210-Summer22](https://github.com/STA210-Summer22 "Course GitHub organization") organization on GitHub. Click on the repo with the prefix **lab-1**. It contains the starter documents you need to complete the lab.
