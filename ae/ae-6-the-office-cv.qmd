...
::: callout-important
Go to the [course GitHub organization](https://github.com/STA210-Summer22) and locate the repo titled `ae-6-the-office-cv-YOUR_GITHUB_USERNAME` to get started.
:::
