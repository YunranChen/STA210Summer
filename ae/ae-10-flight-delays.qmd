...
::: callout-important
Go to the [course GitHub organization](https://github.com/STA210-Summer22) and locate the repo titled `ae-10-flight-delays-YOUR_GITHUB_USERNAME` to get started.
:::
...
3.  Split the data into testing (75%) and training (25%), and save each subset. (Don't forget to set seed)
...
12. Compare two models based on ROC curve. Also, calculate their AUCs, AIC, BIC and construct Drop-in-deviance test to make comparison

13. Choose the best model and construct a hypothesis testing based on the question you are interested in. Also construct a confidence interval of a coefficient you are interested in. Interpret your result

14. Check the conditions of your model and make comments.
