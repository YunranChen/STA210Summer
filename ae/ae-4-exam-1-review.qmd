...
::: callout-important
Go to the [course GitHub organization](https://github.com/STA210-Summer22) and locate the repo titled `ae-4-exam-1-review-YOUR_GITHUB_USERNAME` to get started.
:::
...
13. Suppose you're asked to construct a confidence and a prediction interval for your finding in Exercise 11. Which one would you expect to be wider and why? In your answer clearly state the difference between these intervals.
...
24. Does it make sense to interpret the intercept? Explain your reasoning.

25. According to this model, is the rate of change in tip amount the same for various sizes of parties regardless of alcohol consumption or are they different? Explain your reasoning.
