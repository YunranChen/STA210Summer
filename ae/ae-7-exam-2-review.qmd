...
::: callout-important
Go to the [course GitHub organization](https://github.com/STA210-Summer22) and locate the repo titled `ae-7-exam-2-review-YOUR_GITHUB_USERNAME` to get started.
:::
