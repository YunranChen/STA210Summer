---
title: "AE 13: Tale of Two Creeks"
---

::: callout-important
Go to the [course GitHub organization](https://github.com/STA210-Summer22) and locate the repo titled `ae-13-tale-of-two-creeks-YOUR_GITHUB_USERNAME` to get started.
:::
...
```{r}
sc_raw <- read_csv(here::here("ae/processed-data/schitts-creek.csv"))
dc_raw <- read_csv(here::here("ae/processed-data/dawsons-creek.csv"))
...
write_rds(glm_cv_1, file = "ae/intermediary-output/glm_cv_1.rds")
write_rds(glm_cv_2, file = "ae/intermediary-output/glm_cv_2.rds")
```
...
write_rds(glm_final_1, file = "ae/intermediary-output/glm_final_1.rds")
write_rds(glm_final_2, file = "ae/intermediary-output/glm_final_2.rds")
