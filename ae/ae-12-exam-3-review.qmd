...
Why we use log-odds as response variable: <https://yunranchen.github.io/sta210summer/slides/lec-18.html#/do-teenagers-get-7-hours-of-sleep>
...
Let's extend the model to use force and height to predict the species (Hn, Cp, and Lb). The model output is below:
