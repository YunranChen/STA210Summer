...
::: callout-important
Go to the [course GitHub organization](https://github.com/STA210-Summer22) and locate the repo titled `ae-3-YOUR_GITHUB_USERNAME` to get started.
:::
...
Hint: use [`scale_continuous()`](https://ggplot2.tidyverse.org/reference/scale_continuous.html) 
